...
%token PLUS MODULO UNDERSCORE LPAREN RPAREN LCURLY RCURLY COMMA SEQ COLON DOT NEQUALS EQUALS TRUE FALSE CALL
       ...
       INT BOOL COND FUNC REF LOW HIGH ERASE CHANNEL DECLASSIFY TOP  NORMAL  MUTABLE IMMUTABLE CARET ENCLAVE_ENTRY
...
stmt : IF bexp THEN stmt ELSE stmt ENDIF  	{ EIf($2, $4, $6) }
     ...
     | ENCLAVE_ENTRY LPAREN INTEGER COMMA stmt RPAREN  {EEnclave($3, $5)} 
